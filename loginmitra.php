...
if(isset($_POST['login'])){
    ...
    $login = mysqli_query($koneksi, "select * from mitra where username ='$Username'");
    ...
    if($cek === 1)
    {
        ...
        if($cek_password <> $Password){
            ...
            echo "<script>alert('Login Berhasil');
                document.location='indexmitra.HTML'</script>";
        }
    }else
    {
    ...
    <img class="tengah" src="logo.jpeg"/><br/>
        <div class="data-form">
                <form method="post" action="#">
                    ...
                    <h6 style="text-align:center"><b>Login sebagai Mitra Jasa :</b></h6>
                    ...
                    <center>
                      ...
                      <a class="link" href="mac.php">Don't have an account? Register Now!</a>
		                </center>
