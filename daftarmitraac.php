...
if (isset($_POST['idaftar'])) {
    $simpan = mysqli_query($koneksi, "INSERT INTO ac (Username, Nama_Perusahaan, Deskripsi, Pengalaman_Kerja, Nohp, Email, Password, Alamat)
...
<head>
    ...
    <title>Pendaftaran Mitra Jasa AC</title>
...
<body>
   ...
   <div class="data-form">
        <form method="post" action="#">
            <h6 style="text-align:center">Pendaftaran Mitra Jasa AC</h6>
