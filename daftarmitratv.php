...
if (isset($_POST['idaftar'])) {
    $simpan = mysqli_query($koneksi, "INSERT INTO tv (Username, Nama_Perusahaan, Deskripsi, Pengalaman_Kerja, Nohp, Email, Password, Alamat)
...
<head>
    ...
    <title>Pendaftaran Mitra Jasa TV</title>
...
<body>
   ...
   <div class="data-form">
        <form method="post" action="#">
            <h6 style="text-align:center">Pendaftaran Mitra Jasa TV</h6>
            ...
            <div class="form-group">
                ...
                <input type="text" name="deskripsi" class="form-control" placeholder="contoh : Deskripsi Anda" required>
            </div>
            <div class="form-group">
